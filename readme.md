...
👥 Contributors & ResponsibilitiesOrchestration Lead: Responsible for LangGraph architecture, state management, and the retry logic .Text2SQL Architect: Responsible for LLM prompts, DuckDB syntax compliance, and the semantic layer .Frontend & Vis Lead: Responsible for the Streamlit UI and ensuring chart generation safety .
🗺️ Roadmap
[ ] Phase 1: Open Source MVP with DuckDB and Local LLMs .
[ ] Phase 2: Integration of "Impact Analysis Agent" and RAG architecture.
